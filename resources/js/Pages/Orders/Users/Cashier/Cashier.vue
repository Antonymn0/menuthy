     ...
     <div class="parent-div m-1 pt-2 mx-auto">       
        <div class=" row p-3">  
            ...
            <p class="col-md-6 float-right text-right">
                ...
                <a href="#" class="btn btn-primary" @click.prevent="refreshOrders()">  <i class="bi bi-arrow-repeat  pr-1"></i> Refresh</a>
            </p> 
        </div>
        <div>
            <!-- audio player  -->
                ...
                <tbody v-for="(order, index) in this.current_orders.data" :key="order.id" >
                    <tr class="accordion border-bottom" onclick="toggleAccordion()">
                        ...
                        <td> 
                            ...
                            <span v-if="order.mode_of_payment == 'stripe' && order.paid == 'true' && order.reciept_url !== null" class="text-center"><a :href="order.reciept_url" target="blank" class="btn-primary badge"> View Reciept</a></span>
